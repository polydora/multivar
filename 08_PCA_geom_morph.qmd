...
![](./images/Blubberjellies-KirstiScott-Flickr.jpg)
:::
...
```{r}
#| echo: false
knitr::kable(head(protein), format = "latex", booktabs = TRUE) |>
...
![](images/broken-stick-md.png){width="15%" fig-align="center"} \scriptsize
...
knitr::kable(df, format = "latex", booktabs = TRUE) |>
  ...
  kableExtra::column_spec(1, width = "1.3cm") |>
...
-   Ранги расстояний между объектами на nMDS будут соответствовать их рангам в исходной матрице различий. <br/><br/>
...
Рис. 30.1 из Zuur et al. 2007 \small
...
\textit{Но настоящие джедаи теперь анализируют координаты меток, а не расстояния между ними!}
\end{minipage}
\vspace{1cm}
\centering

\Large \textcolor{mygreen}{Геометрическая морфометрия} \vfill
...
::::: columns
::: {.column width="50%"}
![*Plethodon jordani*](images/PlethodoJordaniJordansSalamander-JohnPClare-Flickr.jpg){width="80%"}
...
::: {.column width="50%"}
![*Plethodon* cf. *teyahalee*](./images/PlethodonCfTeyahalee-squamatologist-Flickr.jpg)
...
![Схема измерений](./images/measurements-Adams2004.jpg){width="80%"}
...
![Прокрустово ложе](./images/Theseus-Procrustes.jpg){width="80%"}
