...
## 7. Анализ главных компонент (Principal Component Analysis, PCA)

```{r eval=FALSE}
install.packages(c("cowplot", "geomorph"))
```

### 7.1 Анализ главных компонент
...
## 10. Канонический корреспондентный анализ (Canonical Correspondence Analysis, CCA)
...
## 11. Анализ избыточности, основанный на расстояниях (distance-based Redundancy Analysis, dbRDA)
