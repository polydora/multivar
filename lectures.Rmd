...
## 3.1 Связь между наборами данных. Тест Мантела. ANOSIM, SIMPER
...
## 5. Анализ главных компонент (Principal Component Analysis, PCA) и (геометрическая) морфометрия

```{r eval=FALSE}
install.packages(c("cowplot", "geomorph", "gridGraphics"))
```

- Презентация [pdf](08_PCA_geom_morph.pdf)
...
[ссылка на яндекс-телемост](https://telemost.yandex.ru/j/38406314560530)

## 6. Корреспондентный анализ (Corespondence Analysis, CA)
...
[**Ссылка на Яндекс-телемост**](https://telemost.yandex.ru/j/95727607758726)
...
## 8. Канонический корреспондентный анализ и анализ избыточности, основанный на расстоянии

### 8.1 Канонический корреспондентный анализ (Canonical Correspondence Analysis, CCA)
...
### 8.2 Анализ избыточности, основанный на расстояниях (distance-based Redundancy Analysis, dbRDA)
...
- Презентация [pdf](05_cluster_analysis.pdf)
- Иерархическая кластеризация [pptx](05_cluster_analysis_animation.pptx)
...
## 10. Современные методы анализа многомерных данных 

### 10.1 Филогенетический анализ в R: визуализация деревьев
...
<!-- - Презентация [pdf](13_Phylogeny.pdf) -->
...
<!-- ### 10.2 Анализ микробиомных данных -->

<!-- ```{r eval = FALSE} -->
<!-- install.packages(c("tidyr", "devtools", "remotes")) -->
<!-- BiocManager::install("phyloseq") -->
<!-- # или -->
<!-- devtools::install_github("phyloseq/joey711") -->
<!-- BiocManager::install('RRPP') -->
...
<!-- - Данные: -->
<!--     + [features.txt](data/master_feature_new.txt) -->
<!--     + [meta.txt](data/master_meta_new.txt) -->
<!--     + [taxa.txt](data/master_taxonomy_new.txt) -->
