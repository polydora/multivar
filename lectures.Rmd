...
## 10. Анализ избыточности (Redundancy analysis, RDA) и Канонический корреспондентный анализ (Canonical Correspondence Analysis, CCA)

### 10.1 Анализ избыточности
...
### 10.2 Канонический корреспондентный анализ
...
## 11. Практикум по применению методов ограниченной ординации

Для каждого набора данных необходимо провести RDA и CCA. Оценить плюсы и минусы полученных ординаций. Подобрать оптимальную модель. Дать интерпретацию полученной модели.
...
- __Деревья на острове Barro Colorado__. Данные из работы *Condit, R, Pitman, N, Leigh, E.G., Chave, J., Terborgh, J., Foster, R.B., Nuñez, P., Aguilar, S., Valencia, R., Villa, G., Muller-Landau, H.C., Losos, E. & Hubbell, S.P. (2002). Beta-diversity in tropical forest trees. Science 295, 666–669.*
    + [BCI_species.csv](data/BCI_species.csv)
    + параметры среды [BCI_env.csv](data/BCI_env.csv)
