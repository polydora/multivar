...
# решение. Если необходимо, настройте вызов `metaMDS()`

# (1) Строим ординацию nMDS
# (2) Оцениваем качество ординации при помощи стресса
# (3) Рисуем график ординациии при помощи функции ordiplot().
