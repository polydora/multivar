...
на наличие в последовательностяx инсерций и делеций. Большинство
...
\pandocbounded{\includegraphics[keepaspectratio]{13_Phylogeny_files/figure-beamer/unnamed-chunk-5-1.pdf}}
\end{frame}
...
в. ``tree bisection and reconnection (TBR, делим дерево пополам и
обратное присоединение)'': делим дерево на 2 самостоятельных поддерева и
снова их соединяем.
\end{frame}
...
\pandocbounded{\includegraphics[keepaspectratio]{13_Phylogeny_files/figure-beamer/unnamed-chunk-11-1.pdf}}
\end{column}
...
\pandocbounded{\includegraphics[keepaspectratio]{13_Phylogeny_files/figure-beamer/unnamed-chunk-14-1.pdf}}
\end{frame}
...
\pandocbounded{\includegraphics[keepaspectratio]{13_Phylogeny_files/figure-beamer/unnamed-chunk-16-1.pdf}}
\end{frame}
...
\pandocbounded{\includegraphics[keepaspectratio]{13_Phylogeny_files/figure-beamer/unnamed-chunk-17-1.pdf}}
\end{frame}
...
\pandocbounded{\includegraphics[keepaspectratio]{13_Phylogeny_files/figure-beamer/unnamed-chunk-18-1.pdf}}
\end{frame}
...
\pandocbounded{\includegraphics[keepaspectratio]{13_Phylogeny_files/figure-beamer/unnamed-chunk-19-1.pdf}}
\end{frame}
...
\pandocbounded{\includegraphics[keepaspectratio]{13_Phylogeny_files/figure-beamer/unnamed-chunk-20-1.pdf}}
\end{frame}
...
\pandocbounded{\includegraphics[keepaspectratio]{13_Phylogeny_files/figure-beamer/unnamed-chunk-21-1.pdf}}
\end{frame}
...
\pandocbounded{\includegraphics[keepaspectratio]{13_Phylogeny_files/figure-beamer/unnamed-chunk-22-1.pdf}}
\end{frame}
...
\pandocbounded{\includegraphics[keepaspectratio]{13_Phylogeny_files/figure-beamer/unnamed-chunk-23-1.pdf}}
\end{frame}
...
\pandocbounded{\includegraphics[keepaspectratio]{cophyplot.png}}
\end{frame}
...
\item
  ...
  Биоинформатики и Полины Дроздовой}
\end{itemize}
\end{frame}
