...
.scroll-box-20[
```{r results='hold', echo=-c(3, 4), purl=FALSE}
library(vegan)
...
.pull-left[
```{r fig-cluster-steps, echo=FALSE, cache=FALSE, opts.label='MxXL'}
library(DiagrammeR)
DiagrammeR(
  "graph TD; 
...
```{r fig-cluster-methods, echo=FALSE, opts.label='LxL'}
library(gridExtra)
...
```{r fig-single, echo=FALSE, opts.label='SxS'}
gg_single
```
]
...
```{r single-ani, echo=FALSE, purl=FALSE, opts.label='XLxXXL', fig.show='animate', interval=2, animation.hook='gifski', aniopts='control,loop', results='hide'}
...
```{r fig-complete, echo=FALSE, opts.label='SxM'}
gg_complete
```
...
```{r complete-ani, echo=FALSE, purl=FALSE, opts.label='XLxXXL', fig.show='animate', interval=2, animation.hook='gifski', aniopts='control,loop', results='hide'}
...
```{r fig-average, echo=FALSE, opts.label='SxM'}
gg_average
```
...
```{r fig-ward, echo=FALSE, opts.label='SxM'}
gg_ward
```
]
